...
class MOSCAN_No_Cross(nn.Module):
    NAME = "MOSCAN"
    def __init__(self, **kwargs):
        super(MOSCAN_No_Cross, self).__init__()
        required_params = [
            "query_cache",
            "input_dims",
            "embed_dim",
...
class MOSCAN_No_Cache(nn.Module):
    NAME = "MOSCAN"
    def __init__(self, **kwargs):
        super(MOSCAN, self).__init__()
        required_params = [
...
class MOSCAN_No_Self(nn.Module):
    NAME = "MOSCAN"
    def __init__(self, **kwargs):
        super(MOSCAN, self).__init__()
        required_params = [
...
class MOSCAN_No_Query(nn.Module):
    NAME = "MOSCAN"
    def __init__(self, **kwargs):
        super(MOSCAN, self).__init__()
        required_params = [
