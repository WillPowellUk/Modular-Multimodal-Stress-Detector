...
WRIST_CONFIG = 'config_files/dataset/wesad_wrist_bvp_eda_temp_configuration.json'
...
DATASETS_PATH = losocv_loader.prepare_datasets(f'src/wesad/WESAD/datasets/wrist/bvp_eda_temp/{WINDOW_LENGTH}s_{SLIDING_LENGTH}s_{SPLIT_LENGTH}s')
