...
# WRIST_CONFIG = f"config_files/dataset/wesad_{TYPE}_{SENSORS}_configuration.json"
# WRIST_FE = f"src/wesad/WESAD/manual_fe/{TYPE}_manual_fe/{WINDOW_LENGTH}s_{SLIDING_LENGTH}s_{SPLIT_LENGTH}s/{TYPE}_features.hdf5"
# dataloader_params = {
#     "batch_size": 32,
#     "shuffle": False,
#     # 'num_workers': 4
