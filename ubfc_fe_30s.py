...
CONFIG = "config_files/dataset/ubfc_bvp_eda_configuration.json"

augmenter = DataAugmenter("src/ubfc_phys/UBFC-PHYS/cleaned/preprocessed.pkl", CONFIG)
batches = augmenter.augment_data(WINDOW_LENGTH, SLIDING_LENGTH)
splitted_segments = augmenter.split_segments(batches, WINDOW_LENGTH // SPLIT_LENGTH)

FE = f"src/ubfc_phys/UBFC-PHYS/manual_fe/{WINDOW_LENGTH}s_{SLIDING_LENGTH}s_{SPLIT_LENGTH}s/all_features_new.hdf5"
